...
function SuggestedAlbums() {
  ...
  return (
    <div className="w-[40vw] max-lg:w-full">
      ...
      <div className="w-full h-[43vh] lg:h-[48vh] overflow-y-auto overflow-x-hidden grid gap-1 items-stretch sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-auto-fill scroll">
        {items}
